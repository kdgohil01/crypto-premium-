  ...
  return (
    <div className="container mx-auto py-4 sm:py-6 md:py-8 px-4 sm:px-6 max-w-6xl">
      ...
      <div className="text-center mb-8 sm:mb-10 md:mb-12">
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gradient mb-4 sm:mb-5 md:mb-6 leading-tight pb-2">Learn Security & Data Processing</h1>
      ...
      {/* Main Concepts */}
      <div className="grid gap-4 sm:gap-6 md:gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 mb-8 sm:mb-10 md:mb-12">
          ...
          <CardContent className="space-y-3 sm:space-y-4 flex-1 flex flex-col">
            <div className="space-y-2 sm:space-y-3 flex-1">
              <div className="flex items-start gap-2 sm:gap-3">
                <Lock className="h-4 w-4 sm:h-5 sm:w-5 text-primary mt-1" />
                <div>
                  <h4 className="font-semibold text-sm sm:text-base">Encryption</h4>
                  <p className="text-xs sm:text-sm text-muted-foreground">Converting readable data into coded form</p>
                </div>
              </div>
              <div className="flex items-start gap-2 sm:gap-3">
                <Key className="h-4 w-4 sm:h-5 sm:w-5 text-primary mt-1" />
                <div>
                  <p className="text-xs sm:text-sm text-muted-foreground">Mathematical methods and secret keys used for encryption</p>
                </div>
              </div>
              <div className="flex items-start gap-2 sm:gap-3">
                <Zap className="h-4 w-4 sm:h-5 sm:w-5 text-primary mt-1" />
                <div>
                  <h4 className="font-semibold text-sm sm:text-base">Modern Applications</h4>
                  <p className="text-xs sm:text-sm text-muted-foreground">HTTPS, banking, messaging apps, and more</p>
                </div>
              </div>
            </div>
            <Button asChild className="w-full bg-primary hover:bg-primary/90 mt-auto text-sm sm:text-base">
